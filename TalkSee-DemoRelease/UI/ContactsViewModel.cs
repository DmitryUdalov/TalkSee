...
namespace PhoneVoIPApp.UI
{
    ...
    public class ContactsViewModel : BaseViewModel
    {
        ...
        private Visibility disabledConnectionTextVisibility;
        public Visibility DisabledConnectionTextVisibility
        {
            get
            {
                return this.disabledConnectionTextVisibility;
            }

            set
            {
                if (this.disabledConnectionTextVisibility != value)
                {
                    this.disabledConnectionTextVisibility = value;
                    this.OnPropertyChanged("DisabledConnectionTextVisibility");
                }
            }
        }

        public void UpdateConnectionState(string recipientName)
        {
            // If there is already a call in progress, show the disabled reason
            this.DisabledConnectionTextVisibility = (!GlobalVariables.isConnected) ? Visibility.Visible : Visibility.Collapsed;
        }
