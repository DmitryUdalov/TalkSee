...
MIDL_DEFINE_GUID(IID, IID___x_ABI_CPhoneVoIPApp_CBackEnd_C____IBackEndAudioPublicNonVirtuals,0xDE465431,0xED24,0x3298,0xA1,0x87,0x8F,0x1A,0xFB,0xBB,0xE1,0x35);
