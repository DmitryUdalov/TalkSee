...
bool CallController::InitiateOutgoingCall(Platform::String^ recepientName, Platform::String^ recepientNumber)
{
    ...
    this->callCoordinator->RequestNewOutgoingCall(this->callInProgressPageUri, recepientName, "PhoneVoipApp", VoipCallMedia::Audio | VoipCallMedia::Video, &outgoingCall);
