...
namespace RelaySampleAppPivot
{
    public partial class App : Application
    {
        ...
        /// <summary>
        /// Gets a static ViewModel used by the views to bind against.
        /// </summary>
        ...
        {
            App.MainViewModel.RelayContext = RelayContext.CreateObject();
        }
        ...
        {
            App.MainViewModel.RelayContext.SaveToStorage();
        }
